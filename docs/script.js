const i18n = {
  es: {
    ...
    footer_copy: "&copy; 2026 Canvas Designer. Una herramienta para mejorar la educación virtual.",
    footer_src: "Código Fuente",
  ...
  en: {
    ...
    footer_copy: "&copy; 2026 Canvas Designer. A tool to improve virtual education.",
