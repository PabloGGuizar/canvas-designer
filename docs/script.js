const i18n = {
  es: {
    ...
    inst_title: "Cómo instalar la extensión",
    inst_desc: "Nuestra extensión se encuentra actualmente en revisión en la Chrome Web Store. Para instalarla, sigue estos pasos:",
    step_1_title: "Visita la Chrome Web Store",
    step_1_desc: "Haz clic en el botón de arriba para ir a la página oficial de la extensión. (Nota: Si aún está en revisión, es posible que el enlace no esté disponible temporalmente).",
    step_2_title: "Añadir a Chrome",
    step_2_desc: "Haz clic en el botón azul <strong>\"Añadir a Chrome\"</strong> y confirma la instalación en la ventana emergente.",
    step_3_title: "Fija la extensión",
    step_3_desc: "Haz clic en el ícono del rompecabezas 🧩 en la esquina superior derecha de tu navegador y presiona el pin 📌 junto a Canvas Designer.",
    step_4_title: "¡Comienza a diseñar!",
    step_4_desc: "Abre cualquier página de tu editor en Canvas LMS y verás un nuevo botón flotante \"✨\" en la esquina inferior derecha.",
    inst_success: "🎉 <strong>¡Listo!</strong> Ahora puedes empezar a transformar tus cursos de forma rápida y sencilla.",
  ...
  en: {
    ...
    inst_title: "How to install the extension",
    inst_desc: "Our extension is currently under review in the Chrome Web Store. To install it, follow these steps:",
    step_1_title: "Visit the Chrome Web Store",
    step_1_desc: "Click the button above to go to the official extension page. (Note: If it's still under review, the link may be temporarily unavailable).",
    step_2_title: "Add to Chrome",
    step_2_desc: "Click the blue <strong>\"Add to Chrome\"</strong> button and confirm the installation in the pop-up window.",
    step_3_title: "Pin the extension",
    step_3_desc: "Click the puzzle icon 🧩 in the top right corner of your browser and click the pin 📌 next to Canvas Designer.",
    step_4_title: "Start designing!",
    step_4_desc: "Open any text editor in Canvas LMS and you will see a new floating \"✨\" button in the bottom right corner.",
    inst_success: "🎉 <strong>Done!</strong> Now you can start transforming your courses quickly and easily.",
