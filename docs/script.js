const i18n = {
  es: {
    ...
    hero_btn_download_ff: "Instalar en Firefox",
    ...
    inst_desc_ff: "Disponible en Firefox Add-ons. ¡Instálala con un solo clic!",
    inst_ff_warning: "",
    ...
    ff_step_1_title: "Abre Firefox Add-ons",
    ff_step_1_desc: "Haz clic en el botón <strong>\"Instalar en Firefox\"</strong> de arriba para ir directamente a la página de la extensión en Firefox Add-ons.",
    ff_step_2_title: "Añadir a Firefox",
    ff_step_2_desc: "Haz clic en el botón azul <strong>\"Agregar a Firefox\"</strong> y confirma los permisos en el cuadro de diálogo que aparece.",
    ff_step_3_title: "¡Listo para usar!",
    ff_step_3_desc: "La extensión se instala automáticamente. Abre Canvas LMS y verás el botón flotante <strong>\"✨\"</strong> en la esquina inferior derecha.",
    ff_step_4_title: "",
    ff_step_4_desc: "",
  ...
  en: {
    ...
    hero_btn_download_ff: "Install on Firefox",
    ...
    inst_desc_ff: "Available on Firefox Add-ons. Install it with a single click!",
    inst_ff_warning: "",
    tab_chrome: "Chrome / Edge / Brave",
    tab_firefox: "Firefox",
    ...
    ff_step_1_title: "Open Firefox Add-ons",
    ff_step_1_desc: "Click the <strong>\"Install on Firefox\"</strong> button above to go directly to the extension page on Firefox Add-ons.",
    ff_step_2_title: "Add to Firefox",
    ff_step_2_desc: "Click the blue <strong>\"Add to Firefox\"</strong> button and confirm the permissions in the dialog that appears.",
    ff_step_3_title: "Ready to use!",
    ff_step_3_desc: "The extension installs automatically. Open Canvas LMS and you'll see the floating <strong>\"✨\"</strong> button in the bottom right corner.",
    ff_step_4_title: "",
    ff_step_4_desc: "",
