...
- **Ideal structure:** Text lines starting with `+`. If you add links (`🔗`) to the text in Canvas, they will be respected!
- **How to do it in the editor:**
  ```text
  + My Super Course
...
### ▾ Dropdown
- **Ideal structure:** Same as navigation, lines starting with `+`.
- **How to do it in the editor:**
  ```text
  + View Modules
  + Module 1
...
- **Ideal structure:** You can use lines starting with `+`, or separate words by commas or regular line breaks.
  ```text
  + Option A
  + Option B
  + Option C
